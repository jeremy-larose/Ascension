        ...
        void LateUpdate()
        {
            ...
            if (m_isHoveringObject)
            {
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    RectTransformUtility.ScreenPointToWorldPointInRectangle(m_TextMeshPro.rectTransform, Input.mousePosition, m_Camera,
                ...
                if (wordIndex != -1 && wordIndex != m_lastWordIndex)
                {
                    ...
                    Vector3 wordPOS =
                        m_TextMeshPro.transform.TransformPoint(m_TextMeshPro.textInfo.characterInfo[wInfo.firstCharacterIndex].bottomLeft);
